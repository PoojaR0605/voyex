...
const MyTrips = () => {
  ...
  const activeTrip = {
    ...
    endDate: '2024-03-28',
    travelers: 4,
    vehicle: '7-Seater SUV',
    status: 'In Progress',
    progress: 45,
    currentLocation: 'Highway Rest Stop, Lonavala',
    eta: '3 hours',
  };
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <div className="text-brand-cyan text-sm font-semibold">{activeTrip.id}</div>
                        </div>
                      ...
                      <div className="mb-3">
                        <div className="flex justify-between text-sm mb-2">
                          ...
                          <span className="text-brand-cyan font-semibold">{activeTrip.progress}%</span>
                        </div>
                      ...
                      <div className="text-sm text-gray-400">
                        ETA: <span className="text-white font-semibold">{activeTrip.eta}</span>
                      </div>
                    </div>
                  </div>
                ...
                <GlassCard className="overflow-hidden group">
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4">
                      ...
                      <div className="text-brand-cyan text-xs font-semibold">{trip.id}</div>
                    </div>
                    <div className="absolute top-4 right-4">
                      <div className="flex items-center bg-dark-bg/80 backdrop-blur-sm px-2 py-1 rounded-full text-xs">
                        <span className="text-yellow-400 mr-1">★</span>
                        <span className="text-white font-semibold">{trip.rating}.0</span>
                      </div>
                    </div>
                  </div>
